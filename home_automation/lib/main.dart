...
class _MyAppState extends State<MyApp> {
  final url = "http://192.168.1.6:5000/getdata";
  final geturl = "http://192.168.1.6:5000/";
  var switStat;
  var s1;
  var s2 = "OFF";
  var s3 = "OFF";
  ...
  void phoneData() async {
    try {
      final response = await post(Uri.parse(url),
          ...
          body: json.encode({"switch": "switch2"}));
      print(response.body);
  ...
  buttonOne() async {
    try {
      final response = await post(Uri.parse(url),
          ...
          body: json.encode({"switch": "switch1"}));
      print(response.body);
      final d = jsonDecode(response.body);
      var switStat = d['data'];
      print(switStat);
  ...
  buttonThree() async {
    try {
      final response = await post(Uri.parse(url),
          ...
          body: json.encode({"switch": "switch3"}));
      print(response.body);
      final d = jsonDecode(response.body);
      var switStat = d['data'];
      print(switStat);
